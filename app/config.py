...
class Settings(BaseSettings):
    ...
    MATTERMOST_API_URL: str = "http://mattermost:8065/api/v4"  # Mattermost API URL
    MATTERMOST_API_TOKEN: Optional[str] = None  # Personal Access Token or Bot Token for API access
